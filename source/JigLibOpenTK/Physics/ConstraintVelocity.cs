        ...
        public override bool Apply(float dt)
        {
            ...
            if (frame == ReferenceFrame.Body) // transfrom velocity to the body frame
            {
                if (doVel)
                {
                    ...
                    Vector3Extensions.TransformNormal(ref vel, ref body.transform.Orientation, out velBodyFrame);
                    #endregion
                ...
                if (doAngVel)
                {
                    ...
                    Vector3Extensions.TransformNormal(ref angVel, ref body.transform.Orientation, out angVelBodyFrame);
                    #endregion
