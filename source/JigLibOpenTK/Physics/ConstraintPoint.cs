...
namespace JigLibX.Physics
{
    ...
    public class ConstraintPoint : Constraint
    {
        ...
        public override void PreApply(float dt)
        {
            ...
            Vector3Extensions.TransformNormal(ref body0Pos, ref body0.transform.Orientation, out R0);
            #endregion

            #region REFERENCE: R1 = Vector3.Transform(body1Pos, body1.Orientation);
            Vector3Extensions.TransformNormal(ref body1Pos, ref body1.transform.Orientation, out R1);
            #endregion
